...
Most of these come down to network reality or how databaseinternals serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

databaseinternals rate-limits like any public site. dbi already paces
...
Where a surface is gated, dbi reads a cookie or token you supply
...
`dbi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dbi actually did
